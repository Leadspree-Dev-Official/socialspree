    ...
    <div className="py-16 sm:py-24 bg-gradient-to-b from-purple-50/40 via-white to-slate-50 font-['Inter']">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-3xl border border-slate-200/80 shadow-md hover:border-purple-300 transition-all">
            <div className="w-12 h-12 rounded-2xl bg-purple-100 text-[#5D3FD3] flex items-center justify-center mb-6 font-bold text-lg">
              01
            </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200/80 shadow-md hover:border-blue-300 transition-all">
            <div className="w-12 h-12 rounded-2xl bg-blue-100 text-[#0066FF] flex items-center justify-center mb-6 font-bold text-lg">
              02
            </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200/80 shadow-md hover:border-emerald-300 transition-all">
            <div className="w-12 h-12 rounded-2xl bg-emerald-100 text-emerald-600 flex items-center justify-center mb-6 font-bold text-lg">
              03
            </div>
            <h3 className="text-xl font-black text-slate-900">Dual Payment Flexibility</h3>
            <p className="text-xs text-slate-600 font-medium mt-2 leading-relaxed">
        ...
        {/* ========================================================================= */}
        <div className="bg-white rounded-3xl border border-slate-200/90 shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-12">
          
          {/* Left Column: Direct WhatsApp & Support SLA (5 Cols) */}
          <div className="lg:col-span-5 bg-slate-950 text-white p-8 sm:p-12 flex flex-col justify-between space-y-8">
          ...
          <div className="lg:col-span-7 p-8 sm:p-12 space-y-6">
            <div>
              <h3 className="text-2xl font-black text-slate-900">Send an Enterprise Inquiry</h3>
            ...
            {submitted ? (
              <div className="p-8 rounded-2xl bg-purple-50 border border-purple-200 text-center space-y-3">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-slate-200 text-xs focus:ring-2 focus:ring-[#5D3FD3] focus:outline-none resize-none"
                  />
                </div>
