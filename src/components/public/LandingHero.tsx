...
export const LandingHero: React.FC<LandingHeroProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFF] font-['Inter'] selection:bg-[#5D3FD3] selection:text-white">
      ...
      {/* ========================================================================= */}
      <section id="overview" className="relative overflow-hidden bg-gradient-to-b from-purple-50/50 via-white to-slate-50 pt-12 pb-16 sm:pt-16 sm:pb-24">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-[500px] pointer-events-none -z-10 overflow-hidden">
          ...
          <div className="absolute top-36 right-1/4 w-[450px] h-[450px] bg-gradient-to-bl from-pink-400/15 to-purple-600/15 rounded-full blur-3xl opacity-60" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-4xl mx-auto space-y-6">
            ...
            <div 
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white border border-purple-200 shadow-xs hover:border-purple-300 hover:scale-102 transition-all cursor-pointer group"
            >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 pt-2">
              ...
              {onInstantDemoLogin && (
                <button
                  ...
                  className="w-full sm:w-auto px-6 py-3.5 rounded-2xl bg-white hover:bg-slate-50 border border-slate-200 hover:border-purple-300 text-slate-800 font-bold text-sm shadow-xs transition-all flex items-center justify-center gap-2 cursor-pointer"
                >
            ...
            <div className="pt-6 flex items-center justify-center gap-3 flex-wrap text-xs text-slate-400 font-medium">
              <span className="font-mono text-slate-500 font-bold uppercase text-[11px]">Supported Networks:</span>
              <span className="px-2.5 py-1 rounded-lg bg-white border border-slate-200 text-slate-700 flex items-center gap-1.5 shadow-xs">
              ...
              <span className="px-2.5 py-1 rounded-lg bg-white border border-slate-200 text-slate-700 flex items-center gap-1.5 shadow-xs">
                <Twitter className="w-3.5 h-3.5 text-slate-800" /> X
              </span>
              <span className="px-2.5 py-1 rounded-lg bg-white border border-slate-200 text-slate-700 flex items-center gap-1.5 shadow-xs">
          ...
          <div className="mt-14 sm:mt-20 pt-10 border-t border-slate-200/80">
