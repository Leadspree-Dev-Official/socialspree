      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="space-y-6 pt-6 border-t border-slate-200/80">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <span className="text-xs font-bold text-slate-500 font-mono">ACTIVE CURRENCY:</span>
            <div className="inline-flex bg-slate-100 p-1 rounded-2xl border border-slate-200/80 shadow-xs">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer ${
                    selectedCurrency === code
                      ? 'bg-white text-[#5D3FD3] shadow-sm border border-slate-200/80 font-extrabold'
            ...
            return (
              <div
                ...
                className={`bg-white rounded-3xl p-8 border flex flex-col justify-between relative transition-all duration-300 ${
                  isPro
                    ? 'border-2 border-[#5D3FD3] shadow-2xl shadow-purple-500/20 scale-[1.02] z-10'
                    : 'border-slate-200/90 hover:border-purple-300 hover:shadow-xl'
                }`}
              >
                ...
                <div>
                  ...
                  <div className="pt-2 flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-mono font-bold uppercase text-purple-600 bg-purple-50 px-2 py-0.5 rounded-md border border-purple-100">
                  ...
                  {priceInfo.displayYearly > 0 ? (
                    <div className="mt-2 text-xs font-bold text-[#5D3FD3] bg-purple-50 px-3 py-1 rounded-xl inline-block font-mono border border-purple-100">
                      Billed annually ({priceInfo.currSym}{priceInfo.displayYearly.toLocaleString()} / year)
                    </div>
                  ) : (
                    <div className="mt-2 text-xs font-bold text-emerald-600 bg-emerald-50 px-3 py-1 rounded-xl inline-block font-mono border border-emerald-100">
