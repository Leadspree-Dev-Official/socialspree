      ...
      <div className="max-w-7xl mx-auto w-full space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-stretch">
          ...
          <div className="md:col-span-5 flex flex-col">
            <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200 shadow-sm flex flex-col justify-between h-full space-y-4">
              
              <div className="space-y-3.5">
                {/* 1. Selected Plan Header */}
                <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                  <div>
                    <span className="text-[9px] font-mono font-bold bg-purple-100 text-[#5D3FD3] px-2.5 py-0.5 rounded-full uppercase tracking-wider">
                      Selected Plan
                    </span>
                  ...
                  <div className="text-right">
                    <div className="text-[#5D3FD3] text-2xl font-black">
                      ...
                      <span className="text-xs font-bold text-slate-500 ml-0.5">/ month</span>
                    </div>
                    {totalAmount > 0 && (
                ...
                <div className="space-y-2">
                  <div className="text-[11px] font-bold text-slate-900 uppercase font-mono tracking-wider">
              ...
              <div className="pt-3 border-t border-slate-100 space-y-2">
                ...
                {isLoaded && isSignedIn ? (
                  <div className="p-2.5 rounded-xl bg-purple-50/80 border border-purple-100 flex items-center gap-2.5">
                    <img 
                      src={user.imageUrl} 
                      alt={user.fullName || 'User Avatar'} 
                      className="w-8 h-8 rounded-lg object-cover border border-purple-200 shadow-xs shrink-0"
                    />
                  ...
                  <div className="p-2.5 rounded-xl bg-amber-50/90 border border-amber-200 flex items-center justify-between gap-2">
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <span className="text-xs font-bold text-amber-900 truncate">Sign In Required</span>
                    </div>

                    <div className="flex items-center gap-1.5 shrink-0">
                      <SignUpButton mode="modal">
                        <button className="py-1 px-2.5 rounded-lg bg-[#5D3FD3] hover:bg-purple-700 text-white text-[11px] font-bold shadow-xs transition-all cursor-pointer">
                          Sign Up
                        </button>
                      </SignUpButton>
                      <SignInButton mode="modal">
                        <button className="py-1 px-2.5 rounded-lg bg-white hover:bg-slate-100 text-slate-800 border border-slate-300 text-[11px] font-bold transition-all cursor-pointer">
                          Sign In
                        </button>
                      </SignInButton>
                    </div>
          ...
          <div className="md:col-span-7 flex flex-col">
            <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200 shadow-sm space-y-3 h-full flex flex-col justify-between">
