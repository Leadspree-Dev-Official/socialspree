...
Deno.serve(async req => {
  ...
  } catch (e) { const n = normalizeZernioError(e); return json({ error: n.message, code: n.code, retryAfterSeconds: n.retryAfterSeconds }, n.statusCode && n.statusCode >= 400 ? n.statusCode : 400); }
});
